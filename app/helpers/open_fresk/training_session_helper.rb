module OpenFresk
  module TrainingSessionHelper
    ...
    def seats_booked_progress_bar(session)
      ...
      content_tag(:div,
                  content_tag(:div, '', class: "progress-bar bg-primary w-#{progress}",
                                        role: 'progressbar', style: "width: #{progress}%",
                                        aria_valuenow: session.confirmed_present_count.to_s,
                                        aria_valuemin: '0', aria_valuemax: session.capacity.to_s),
    ...
    def context_grouped_options_selected(training_session)
      return unless [TrainingSession::Internal, TrainingSession::Commercial].include?(training_session.context)
